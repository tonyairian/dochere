...
import { GET_SPECIALIZATION_DOCTOR,DOCTOR_RE_APPLY } from "../../utils/axios/consturls";
...
const ReApply = () => {
  ...
  useEffect(() => {
    const getSpecializations = async () => {
      ...
      //   "http://localhost:4000/doctor/get-specialization"
      // );
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      //   "http://localhost:4000/doctor/re-apply",
      //   formData
      // );
