...
import { DOCTOR_SIGNUP } from "../utils/axios/consturls";
      ...
      onSubmit: async (values, action) => {
        try {
          ...
          if (data.emailAlreadyExists) {
            ...
            if (data.mailSend) {
              // alert("Verification mail sent please check your Email Doctor");
              toast.info(
                "Verification mail sent please check your Email Doctor",
                {
                  position: "top-right",
                  autoClose: 2000,
                  hideProgressBar: false,
