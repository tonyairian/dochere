...
import { GET_DOCTOR_DETAILS } from "../utils/axios/consturls";
const DoctorNavbar = () => {
  ...
  useEffect(() => {
    doctorInstance.post(GET_DOCTOR_DETAILS, { doctor }).then(({ data }) => {
      if (data.doctor.verified === false) {
        setPending(true);
      }
      if (data.doctor.rejected === true) {
        setRejected(true);
      }
    });
  }, []);
      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            ...
            {rejected ? (
              <>
                {/* <Text fontSize="25px" color="red.600" h="40px">
